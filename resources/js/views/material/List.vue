    ...
    <div class="col-md-12">
        <div class="card" style="min-height: 720px">
            <div class="card-header">
                <h5 style="font-size: 35px">{{translations.material.materials}}</h5>
                <button
                    type="button"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">{{translations.general.add}} {{translations.material.materials}}</h5>
...
<script>
    ...
    export default {
        ...
        methods: {
            getAll() {
                axios.get('/material/all', {params: {page: this.currentPage, is_paginate: 1}}).then(response => {
            ...
            createItem() {
                ...
                axios.post('/material/create', this.newItem).then(response => {
                    console.log(response.data.data);
                    this.newItem = {name_ar: null, name_en: null};
                    this.getAll();
                    // this.items.unshift(this.newItem);
                    $('#exampleModal').modal('hide');
                    swal("Good job!", "A new Material has been added!", "success");
                })
                    .catch(err => {
