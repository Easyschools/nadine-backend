...
<head>
    ...
    <title>Reset password templete</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        a {
        ...
        <tr style="border-collapse:collapse;">
            <td valign="top" style="padding:0;Margin:0;">
                ...
                <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                    ...
                    <tr style="border-collapse:collapse;">
                        <td style="padding:0;Margin:0;background-color:#4680ff;" bgcolor="#4680ff" align="center">
                            <table class="es-header-body" width="600" cellspacing="0" cellpadding="0" align="center"
                                   bgcolor="#4680ff"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#4680ff;">
                                <tr style="border-collapse:collapse;">
                                    <td align="left"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                ...
                                                                <img src="images/7331519201751184.png" alt=""
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td width="540" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                style="Margin:0;padding-left:10px;padding-right:10px;padding-top:40px;padding-bottom:40px;"> <span
                                                                    class="es-button-border"
                                                                    style="border-style:solid;border-color:#7C72DC;background:#4680ff;border-width:1px;display:inline-block;border-radius:2px;width:auto;">
                                                                        <a href="{{url('/user/forget-password?&token='.@$token.'&email='.@$email.'&name='.@$name)}}"
                                                                           class="es-button" target="_blank"
                                                                           style="mso-style-priority:100 !important;text-decoration:none !important;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:20px;color:#FFFFFF;border-style:solid;border-color:#4680ff;border-width:15px 25px 15px 25px;display:inline-block;background:#4680ff;border-radius:2px;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;">
                                                                        Reset Password
                                                                    </a>
