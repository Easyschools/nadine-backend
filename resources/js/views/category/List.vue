            ...
            <tbody>
              <tr v-for="(item, index) in items">
                ...
                <td>
                  <router-link
                    :to="{
                      path: '/admin/category/edit/' + item.id,
                      params: { id: item.id },
                    }"
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
                {{ translations.general.add }} {{ translations.category.categories }}
              </h5>
...
export default {
  ...
  methods: {
    getAll() {
      axios
        .get("/category/all", { params: { page: this.currentPage, is_paginate: 1 } })
        .then((response) => {
    ...
    createItem() {
      ...
      axios
        .post("/category/create", this.newItem)
        .then((response) => {
